...
**     Contents  :
**
**         RecvChar              - byte SPI_RecvChar(_TComData *Chr);
**         SendChar              - byte SPI_SendChar(_TComData Chr);
...
**         SetIdleClockPolarity  - byte SPI_SetIdleClockPolarity(byte Level);
**
**
...
/*
** ===================================================================
**     Method      :  SPI_RecvChar (bean SynchroMaster)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  SPI_SendChar (bean SynchroMaster)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  SPI_CharsInRxBuf (bean SynchroMaster)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  SPI_GetCharsInRxBuf (bean SynchroMaster)
**
**     Description :
**         Return number of characters in the input buffer.
...
/*
** ===================================================================
**     Method      :  SPI_SetShiftClockPolarity (bean SynchroMaster)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  SPI_SetIdleClockPolarity (bean SynchroMaster)
**
**     Description :
...
** ===================================================================
*/
byte SPI_SetIdleClockPolarity(byte Level)
{
  if(Level > 1)
    return ERR_RANGE;
  if(SPCR_CPOL != Level) {
...
/*
** ===================================================================
**     Method      :  SPI_Init (bean SynchroMaster)
**
**     Description :
**         This method is internal. It is used by Processor Expert
**         only.
...
void SPI_Init(void)
{
  ...
  SPSCR = 3;                           /* Set the baud rate register */
