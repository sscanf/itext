...
void _EntryPoint(void)
{
  ...
  /* CONFIG1: COPRS=0,LVISTOP=0,LVIRSTD=0,LVIPWRD=0,LVI5OR3=1,SSREC=0,STOP=0,COPD=1 */
  CONFIG1 = 9;                         /* Set the CONFIG1 register */
  /* CONFIG2: ??=0,??=0,??=0,??=0,??=0,??=0,OSCSTOPENB=0,SCIBDSRC=0 */
  ...
  PCTL = 0;
  PCTL_VPR = 2;
  PBWC = 160;                          /* Select the operating modes */
